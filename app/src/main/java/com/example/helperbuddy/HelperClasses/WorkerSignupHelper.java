...
public class WorkerSignupHelper {   //This class is use to get all the details of Worker and used in WorkerSignup class
    ...
    public WorkerSignupHelper(String name, String username, String occupation, String address, String description, String phoneNo, String password, String images, String total_ratings, String total_users) {
        this.name = name;
