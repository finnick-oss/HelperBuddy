...
public class WorkerSigup extends AppCompatActivity {
    ...
    TextInputLayout regName, regUsername, regoccupation, regPhoneNo, regPassword, regaddress, regdescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // regoccupation = findViewById(R.id.reg1_occupation);
        regaddress = findViewById(R.id.reg1_address);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            storageReference.child(userName + "." + getFileExtension(imageUri)).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    //  String[] OccupationArray1 = input.split("\\s*,\\s*");
                                    ...
                                    WorkerSignupHelper user = new WorkerSignupHelper(name, username, OccupationArray, address, description, number, password, images,Total_ratings,Total_ratings);
